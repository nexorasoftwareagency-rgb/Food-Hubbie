...
export function Header({ onMenuClick, onNotifClick }: { onMenuClick: () => void; onNotifClick: () => void }) {
  ...
  return (
    <header
      className="flex flex-col sticky top-0 z-20 bg-card border-b border-border"
    >
      <div className="flex items-center gap-2.5 px-3.5" style={{ height: "var(--header-height)" }}>
        ...
        <div className="flex-1 min-w-0">
          <b className="block text-[13px] font-extrabold tracking-tight truncate">FOODHUBBIE</b>
