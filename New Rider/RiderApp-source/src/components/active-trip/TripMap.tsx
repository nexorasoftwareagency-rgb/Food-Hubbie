...
const riderIcon = L.divIcon({
  className: "",
  html: `<div style="width:18px;height:18px;border-radius:50%;background:#FF5200;border:3px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,.3);" class="animate-pulse-dot"></div>`,
  iconSize: [18, 18],
  iconAnchor: [9, 9],
});
      ...
      >
        ...
        {riderPos && destPos && (
          <Polyline
            ...
            pathOptions={{ color: "#FF5200", weight: 3, dashArray: "6 8", opacity: 0.6 }}
          />
        )}
