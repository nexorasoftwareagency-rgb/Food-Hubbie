  ...
  return (
    <div className="grid grid-cols-2 gap-2.5 mb-4">
      <div className="rounded-[14px] bg-card border border-border/70 p-3.5">
        <div className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Cash to Settle</div>
        <div className="text-[16px] font-extrabold mt-1 mb-2">{formatCurrency(unsettledCash)}</div>
