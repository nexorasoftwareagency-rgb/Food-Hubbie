...
export function LoginCard() {
  return (
    <div className="relative z-[2] w-full max-w-[320px] rounded-[24px] bg-white/[0.06] border border-white/[0.12] backdrop-blur-xl p-7 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
      <div className="mx-auto mb-4 flex size-[58px] items-center justify-center rounded-[18px] bg-gradient-to-br from-[#FF5200] to-[#E64A00] shadow-[0_8px_24px_rgba(255,82,0,0.35)]">
