  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full mt-3 rounded-xl bg-gradient-to-br from-[#FF5200] to-[#E64A00] py-3.5 text-[14px] font-extrabold text-white shadow-[0_10px_24px_rgba(255,82,0,0.35)] disabled:opacity-70 flex items-center justify-center gap-2"
      >
        {submitting ? (
          <>
      ...
      <div className="flex items-center justify-center gap-1.5 mt-4 text-[10.5px] font-medium text-white/35">
        <ShieldCheck size={12} /> Secured with Firebase Auth
      </div>
