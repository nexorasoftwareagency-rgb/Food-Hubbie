  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: bg, fontFamily:"'Inter', sans-serif", color: textCol }}>
      ...
      <aside
        ...
        style={{ width: collapsed ? 56 : 224, background: sideBg, borderRight:`1px solid rgba(243,107,33,0.1)`, flexShrink:0, minWidth: collapsed ? 56 : 224 }}>

        {/* Logo */}
        <div className="flex items-center gap-2.5 px-3 py-4 border-b" style={{ borderColor:"rgba(243,107,33,0.1)" }}>
        ...
        {/* Bottom */}
        <div className="px-1.5 pb-3 border-t space-y-1 pt-2" style={{ borderColor:"rgba(243,107,33,0.1)" }}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="flex items-center gap-3 px-4 py-3 border-b flex-shrink-0 z-10"
          style={{ background: sideBg, borderColor:"rgba(243,107,33,0.1)" }}>
