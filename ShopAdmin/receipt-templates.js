...
window.ReceiptTemplates = {
    ...
    generateThermalReceipt: function(order, store, isReprint = false) {
        ...
        const baseUrl = store.reviewUrl || `https://foodhubbie.web.app/feedback`;
            ...
            <body>
                <div class="center">
                    ...
                    ${(!store.config || store.config.showStoreName !== false) ? `
                        ...
                        <h1 class="store-name">${this.escapeHtml(store.storeName || 'Foodhubbie')}</h1>
                    ` : ''}
                ...
                <div class="footer center">
                    ...
                    <div style="margin-top:5px; font-size: 0.65rem; opacity:0.7;">
                        ${this.escapeHtml(store.poweredBy || 'Powered by Foodhubbie SaaS')}
                    </div>` : ''}
